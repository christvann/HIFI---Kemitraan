<template>
  <div class="w-[684.92px] h-[538.92px] rounded-lg shadow-lg bg-[#FFFFFF] border-collapse">
    <button @click="closePopup" class="absolute text-[#2671D9] w-[14px] h-[14px] text-[20px] left-[639px] top-[13px]">&times;</button>
    <div class="flex">
    ...
    <h1 class="items-start justify-center px-2 ml-2 text-[#9C9C9C]">$judul_pengajuan</h1>
      <div :class="boxClass1" class="flex flex-col w-[289px] h-[130px] rounded-lg mt-6 ml-5 border-[1px] border-[#DEDEDE]">
        <div :class="headerClass1" class="w-full h-[40px] p-4 flex justify-between items-center rounded-t-lg">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="w-[33px] h-[28px] absolute top-[135px] left-[325px]" viewBox="0 0 33 28" fill="none">
      ...
      <div :class="boxClass2" class="flex flex-col w-[289px] h-[130px] rounded-lg mt-6 ml-[64px] absolute top-[62px] left-[310px] border-[1px] border-[#DEDEDE]">
        <div :class="headerClass2" class="w-full h-[40px] p-4 flex justify-between items-center rounded-t-lg">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="w-[33px] h-[32px] absolute left-[505px] top-[233px]" viewBox="0 0 32 33" fill="none">
      ...
      <div :class="boxClass3" class="absolute flex flex-col w-[289px] h-[130px] rounded-lg top-[283px] left-[374px] border-[1px] border-[#DEDEDE]">
        <div :class="headerClass3" class="w-full h-[40px] p-4 flex justify-between items-center rounded-t-lg">
          <div class="font-sans text-[14px] font-semibold text-white">{{ fileUploaded3 ? 'MoU/NDA' : 'MoU/NDA' }}</div>
        </div>
        <div v-if="!fileUploaded3" class="flex flex-col ml-4 mt-[10px]">
          <p class="font-sans text-[#333333] text-[12px] font-normal">Dokumen MoU/NDA</p>
          <label class="bg-[#2671D9] text-white w-[73px] h-[25px] rounded mt-[12px] cursor-pointer inline-flex items-center justify-center text-[8.75px] font-sans font-semibold">
            <div class="flex items-center">
              <svg class="mr-1" width="9" height="7" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.87337 1.13053C3.01762 1.13053 2.32389 1.82426 2.32389 2.68001C2.32389 2.77881 2.33309 2.87512 2.35059 2.96824C2.38432 3.14782 2.27992 3.32463 2.10638 3.38182C1.59703 3.54968 1.23014 4.02951 1.23014 4.59407C1.23014 5.29881 1.80145 5.87012 2.50618 5.87012H6.60775C7.16147 5.87012 7.61035 5.42124 7.61035 4.86751C7.61035 4.43975 7.3423 4.07368 6.96375 3.92985C6.77894 3.85963 6.68377 3.65491 6.74921 3.46836C6.77555 3.39326 6.79004 3.31216 6.79004 3.22689C6.79004 2.82418 6.46358 2.49772 6.06087 2.49772C5.98167 2.49772 5.9061 2.51022 5.83562 2.53308C5.74043 2.56395 5.63673 2.55433 5.54884 2.50649C5.46095 2.45864 5.39658 2.37677 5.37084 2.28007C5.19455 1.61791 4.59041 1.13053 3.87337 1.13053ZM1.59473 2.68001C1.59473 1.42155 2.61491 0.401367 3.87337 0.401367C4.80935 0.401367 5.61285 0.965434 5.96369 1.77176C5.99584 1.76963 6.02825 1.76855 6.06087 1.76855C6.86629 1.76855 7.51921 2.42147 7.51921 3.22689C7.51921 3.28171 7.51616 3.33591 7.51023 3.3893C8.00728 3.69338 8.33952 4.24132 8.33952 4.86751C8.33952 5.82394 7.56418 6.59928 6.60775 6.59928H2.50618C1.39874 6.59928 0.500977 5.70152 0.500977 4.59407C0.500977 3.81305 0.947312 3.13701 1.59815 2.80588C1.59588 2.76418 1.59473 2.72222 1.59473 2.68001ZM4.16245 2.42221C4.30483 2.27983 4.53567 2.27983 4.67805 2.42221L5.7718 3.51596C5.91418 3.65834 5.91418 3.88918 5.7718 4.03156C5.62942 4.17394 5.39858 4.17394 5.2562 4.03156L4.78483 3.56019L4.78483 5.14095C4.78483 5.3423 4.6216 5.50553 4.42025 5.50553C4.21889 5.50553 4.05566 5.3423 4.05566 5.14095L4.05566 3.56019L3.5843 4.03156C3.44192 4.17394 3.21108 4.17394 3.0687 4.03156C2.92632 3.88918 2.92632 3.65834 3.0687 3.51596L4.16245 2.42221Z" fill="white"/>
      ...
      <img src="../assets/image/Line.png" class="w-[644.92px] mt-[223px] ml-5">
      <button class="justify-center w-[83px] h-[40px] border-collapse bg-[#2671D9] ml-[581.92px] mt-[27px] rounded-lg text-[#FFFFFF] font-sans font-semibold">Kirim</button>
    </div>
</template>
