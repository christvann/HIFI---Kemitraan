<template>
  ...
  <div class="px-4 py-3">
    <div class="h-[776px] w-auto rounded-lg bg-[#FFFFFF] border-collapse">
      ...
      <button class="flex-grow w-[129px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4 text-[#2671D9]" @click="navigateToApprovalSelesai">
        Approval Selesai
        <img src="@/assets/image/LineBlue.png" class="w-[129px] h-[4px] mt-2" />
      </button>
      <button class="flex-grow w-[158px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4" @click="navigateToApprovalStopclock">Approval Stop Clock</button>
...
export default {
  ...
  methods: {
    navigateToDetail() {
      this.$router.push("/approval/detailpengajuanapproval");
    },
