<template>
    ...
    <div class="px-4 py-3">
      <div class="h-[776px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse">
          <div class="flex">
          ...
          <button class='flex-grow w-[129px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4'
            @click="navigateToApprovalSelesai">Approval Selesai
            </button>
          <button class='flex-grow w-[158px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4 text-[#2671D9]'
            @click="navigateToApprovalStopclock">Approval Stop Clock
            <img 
              src="@/assets/image/LineBlue.png" class="w-[158px] h-[4px] mt-2">
          </button>
