<template>
  ...
  <div class="px-4 py-3">
    <div class="h-[776px] w-auto rounded-lg bg-[#FFFFFF] border-collapse">
      <div class="flex">
      ...
      <button class="flex-grow w-[129px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4" @click="navigateToApprovalSelesai">Approval Selesai</button>
      <button class="flex-grow w-[158px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4 text-[#2671D9]" @click="navigateToApprovalStopclock">
        Approval Stop Clock
        <img src="@/assets/image/LineBlue.png" class="w-[158px] h-[4px] mt-2" />
      </button>
        ...
        <div class="filter-button">
          <button @click="toggleDropdown" class="flex">
            <div class="flex items-center justify-center w-[90px] h-[40px] rounded-lg bg-[#FFFFFF] border border-[#E5E7E9] ml-2 mt-6">
              ...
              <span class="text-[14px] font-sans font-medium text-[#333333] ml-3">Filter</span>
            </div>
          </button>
              ...
              <tbody>
                <tr v-for="(item, index) in tableData" :key="index" class="bg-[#FFFFFF] border border-[#E5E7E9] text-[12px] text-[#4D5E80] font-sans font-semibold">
                  ...
                  <td class="p-2 border border-[#E5E7E9]">
                    <span class="w-[55px] h-[24px] px-4 py-1 rounded-full font-sans text-[12px] text-[#FF8000] bg-[#FFF3E6] border-[1px] border-[#FFD6AD]">
                      {{ item.status }}
                    </span>
                  </td>
...
export default {
  ...
  methods: {
    navigateToDetail() {
      this.$router.push("/approval/approvalstopclock/detailpengajuanapprovalstopclock");
    },
