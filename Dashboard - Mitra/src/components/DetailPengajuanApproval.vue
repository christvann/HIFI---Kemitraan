  ...
  <div>
    ...
    <div class="px-4 py-3">
      <div class="relative h-[2024px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse">
        ...
        <button @click="showApprovalPopup = true" class="absolute bottom-[12px] right-[24px] flex">
        ...
        <div v-if="showApprovalPopup" class="fixed inset-0 flex items-center justify-center bg-[#1F2937] bg-opacity-50">
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[360px] h-[500px]">
            ...
            <div class="flex flex-col justify-center items-center mt-14 ml-8 mr-8 mb-14">
              ...
              <p class="text-[16px] font-sans text-[#333333] font-normal mb-6 text-center">Apakah Anda yakin ingin menyetujui pengajuan ini? Proses pengajuan kemitraan akan diselesaikan.</p>
              <button @click="approvePengajuan" class="bg-[#2671D9] text-[#FFFFFF] text-[14px] p-2 rounded-lg w-full mb-2">Setujui</button>
              <button @click="closeApprovalPopup" class="border-[1px] bg-[#FFFFFF] text-[#2671D9] border-[#2671D9] text-[14px] p-2 rounded-lg w-full">Batal</button>
            </div>
          </div>
        </div>
        <!-- Popup kedua (PengajuanDisetujuiPopup) -->
        <div v-if="showDisetujuiPopup" class="fixed inset-0 flex items-center justify-center bg-[#1F2937] bg-opacity-50">
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[360px] h-[476px]">
            <div class="flex flex-col items-center mt-14 ml-8 mr-8 mb-14">
              ...
              <h2 class="text-[20px] font-sans font-semibold text-[#333333] mb-2">Pengajuan Telah Disetujui</h2>
              <p class="text-[16px] font-sans text-[#333333] font-normal mb-6 text-center">Anda telah berhasil menyetujui pengajuan ini. Proses pengajuan kemitraan telah selesai. Silakan cek pengajuan pada menu Selesai.</p>
