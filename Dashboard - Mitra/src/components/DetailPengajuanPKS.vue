<template>
  <div>
    ...
    <div class="px-4 py-3">
      <div class="relative h-[2232px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse">
        <div class="flex">
          <img src="../assets/image/Rectangle.png" class="ml-4 mt-[18px] h-[28px]" />
          ...
          <div class="relative mt-4 mb-4 items-start w-[209px] h-[72px] border-[1px] border-[#E5E7E9] rounded-md">
            ...
            <div class="flex items-center">
              ...
              <button @click="showPopup = true" class="ml-[80px]">
        ...
        <div class="flex items-center mt-4 ml-4 w-[1046px] h-[48px] rounded-lg bg-[#FFFFFF] border-[#E5E7E9] border-[1px]">
          ...
          <div class="text-[16px] font-sans font-bold text-[#333333] ml-[10px] mt-[14.5px] mb-[14.5px]">Dokumen Progress Kemitraan</div>
          <button @click="toggleDropdownArrow" class="ml-auto mr-4 flex py-1 px-1 rounded-full hover:bg-[#FFFFFF]">
            <svg class="w-4 h-4 text-[#2671D9]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
        ...
        <button class="absolute bottom-[12px] right-[123px] mt-4 flex">
          <div class="flex items-center justify-center w-[101px] h-[40px] rounded-lg bg-[#FFFFFF] border-[#2671D9] border-[1px]">
            <span class="text-[14px] font-sans text-[#2671D9] ml-3 mt-[9px] mr-3 mb-[9px]">Stop Clock</span>
          </div>
        </button>
        <button @click="showPenyelesaianPKSPopup = true" class="absolute bottom-[12px] right-[24px] flex">
          <div class="flex items-center justify-center w-[83px] h-[40px] rounded-lg bg-[#E6E6E6] border-[#FFFFFF] border-[1px]">
            <span class="text-[14px] font-sans text-[#7F7F80] ml-3 mt-[9px] mr-3 mb-[9px]">Selesai</span>
          </div>
        </button>
        <div v-if="showPenyelesaianPKSPopup" class="fixed inset-0 flex items-center justify-center bg-[#1F2937] bg-opacity-50">
          <div class="bg-[#FFFFFF] rounded-lg shadow-lg w-[502px] h-[596px]">
            <div class="flex w-[502px] h-[76px] bg-[#E9F1FB] border-[#DEDEDE] rounded-tl-lg rounded-tr-lg">
              ...
              <button @click="closePenyelesaianPKSPopup" class="text-[#CCCCCC] absolute right-[450px] mt-5 mr-2 text-[20px]">&times;</button>
            </div>
            <div class="flex flex-col justify-start items-start mt-4 ml-6 mr-8">
              ...
              <div class="flex flex-col w-[454.5px] h-[72px]">
                ...
                <input type="text" placeholder="Masukkan Nomor PKS" class="w-[454.5px] h-[40px] rounded-md bg-[#FFFFFF] border border-[#E5E7E9] mt-2 pl-4 font-sans text-[14px] text-[#7F7F80] font-extralight outline-none" />
              </div>
              <div class="relative flex flex-col w-[454.5px] h-[72px] mt-4">
                ...
                <input
                  ...
                  type="date"
                  class="custom-date-picker absolute border border-[#E5E7E9] font-sans text-[10px] text-[#9C9C9C] rounded-lg p-2 w-[120px] z-10"
              ...
              <div class="flex flex-col w-[454.5px] h-[72px] mt-4">
                ...
                <input type="text" placeholder="Cari Nama Pejabat" class="w-[454.5px] h-[40px] rounded-md bg-[#FFFFFF] border border-[#E5E7E9] mt-2 pl-4 font-sans text-[14px] text-[#7F7F80] font-extralight outline-none" />
                <span class="absolute right-[475px] bottom-[150px] cursor-pointer">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
              ...
              <button @click="Progress" class="absolute bottom-[60px] right-[462px] flex">
                <div class="flex items-center justify-center w-[78px] h-[40px] rounded-lg bg-[#2671D9] border-[#FFFFFF] border-[1px]">
                  <span class="text-[14px] font-sans text-[#FFFFFF] ml-3 mt-[9px] mr-3 mb-[9px]">Kirim</span>
                </div>
              </button>
            </div>
          </div>
