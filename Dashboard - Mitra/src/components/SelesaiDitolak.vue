<template>
  ...
  <div class="px-4 py-3">
    <div class="h-[776px] w-auto rounded-lg bg-[#FFFFFF] border-collapse">
      ...
      <button class="flex-grow w-[56px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4" @click="navigateToSelesai">Selesai</button>
      <button class="w-[54px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-4 text-[#2671D9]" @click="navigateToDitolak">
        Ditolak
