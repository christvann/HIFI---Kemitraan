<template>
    ...
    <div class="px-4 py-3">
      <div class="h-[776px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse">
          ...
          <button class='flex-grow w-[56px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-8 mr-4 text-[#2671D9]'
            @click="navigateToSelesai">Selesai
            <img 
              src="@/assets/image/LineBlue.png" class="w-[129px] h-[4px] mt-2">
          </button>
          <button 
            :class="['flex-grow w-[56px] h-[24px] font-sans text-[16px] font-semibold mt-7 ml-4 mr-4',
                selectedTable === 'ApprovalDitolak' ? 'text-[#2671D9]' : 'text-[#333333]']"
            @click="navigateToDitolak">Ditolak
          </button>
