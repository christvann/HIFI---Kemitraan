  ...
  data() {
    return {
      ...
      tableData: [
        ...
        { judul: "Lorem ipsum dolor sit amet", nomor: 90224, tipe: "MoU", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90224, tipe: "PKS", user: "Sales", status: "Revisi Minor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90224, tipe: "MoU", user: "Produk", status: "Revisi Mayor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90224, tipe: "MoU", user: "Sales", status: "Reject ke User" },
      ],
    };
  },
  computed: {
