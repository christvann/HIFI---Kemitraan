  ...
  <div class="px-4 py-3">
    <div class="h-[712px] w-auto rounded-lg bg-[#FFFFFF] border-collapse">
      <div class="flex">
        ...
        <h1 class="font-sans text-[20px] text-[#333333] mt-2 ml-[5px] font-semibold">Proses</h1>
      </div>
  ...
  data() {
    return {
      ...
      filterOptions: [
        ...
        { name: "Progress Kemitraan", subOptions: ["Surat Penawaran", "Proposal", "Evaluasi", "Surat Pesanan", "BAK Pemilihan Mitra", "Negosiasi", "PKS"] },
      ],
      ...
      tableData: [
        { judul: "lorem ipsum", nomor: 90224, tipe: "MoU", user: "pusat", date: "15 Hari", pic: "Farhan", progress: "Surat Penawaran" },
        { judul: "lorem ipsum", nomor: 90224, tipe: "MoU", user: "pusat", date: "15 Hari", pic: "Nathan", progress: "Proposal" },
  ...
  computed: {
    ...
    filteredTableData() {
      ...
      return this.tableData.filter((item) => {
        return this.selectedSubOptions.includes(item.progress) || this.selectedSubOptions.includes(item.tipe);
      });
    },
  },
  ...
  methods: {
    navigateToDetail(tipe) {
      if (tipe.toUpperCase() === "PKS") {
        this.$router.push({ name: "DetailPengajuanPKSstaff" });
      } else if (tipe.toUpperCase() === "MOU") {
        this.$router.push({ name: "DetailPengajuanMoUStaff" });
      }
    },
    toggleDatePicker() {
