      ...
      <div class="absolute mt-[675px] inset-0 flex items-center justify-center">
        <div class="custom-bg w-[588px] h-[156px] rounded-md text-center flex flex-col items-center justify-center">
          <h1 class="text-[#E9EAEC] font-sans font-semibold text-[26px]">
            "Welcome to DIAMOND<br />
            (Digital Administration Monitoring<br />
            Dashboard)"
          </h1>
        </div>
      </div>
      ...
      <div class="w-auto h-[404px] bg-[#FFFFFF] mt-[48px]">
        ...
        <div class="w-[480px] h-[168px] bg-[#FFFFFF] mt-8">
          ...
          <div class="relative w-[480px] h-[112px] bg-[#FFFFFF] mt-8">
            <button @click="navigateToDetail" class="w-[480px] h-[48px] bg-[#2671D9] hover:bg-[#1E5BB7] rounded-md text-[#FFFFFF] font-sans font-medium text-[14px]">Login</button>
