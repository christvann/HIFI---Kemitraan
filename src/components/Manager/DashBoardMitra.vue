      ...
      <div class="blue-box mt-3 ml-4 mr-4 w-[1046px] h-[100px] relative">
        <div class="flex items-start">
          <div>
            ...
            <span class="flex text-white font-sans font-normal text-[20px] px-5"> Manager Sub Bidang Kemitraan Bisnis Konektivitas dan Infrastruktur </span>
          </div>
...
export default {
  ...
  methods: {
    ...
    handleClickOutside(event) {
      ...
      if (datePickerButton && !datePickerButton.contains(event.target) && 
