  ...
  data() {
    return {
      ...
      tableData: [
        ...
        { judul: "Perjanjian Kerja Sama Pengembangan Aplikasi", nomor: 301423, tipe: "MoU", user: "Marketing", status: "Diproses" },
        { judul: "Kerja Sama Penyediaan Infrastruktur Jaringan", nomor: 302423, tipe: "PKS", user: "IT", status: "Selesai" },
        { judul: "Perjanjian Kerja Sama Penelitian Teknologi", nomor: 301623, tipe: "MoU", user: "R&D", status: "Masuk" },
        { judul: "Kontrak Kerja Sama Penyediaan Layanan", nomor: 302223, tipe: "PKS", user: "Finance", status: "Ditolak" },
        { judul: "Kerja Sama Pengembangan Produk Baru", nomor: 301723, tipe: "MoU", user: "Produk", status: "Masuk" },
        { judul: "Kesepakatan Kerja Sama Pemasaran Digital", nomor: 301923, tipe: "MoU", user: "Sales", status: "Selesai" },
        { judul: "Perjanjian Kerja Sama Pelatihan SDM", nomor: 302823, tipe: "MoU", user: "HR", status: "Diproses" },
        { judul: "MoU Kerja Sama Penelitian dan Pengembangan", nomor: 302023, tipe: "MoU", user: "R&D", status: "Selesai" },
        { judul: "NDA Kerja Sama Keamanan Data", nomor: 301823, tipe: "NDA", user: "Legal", status: "Masuk" },
        { judul: "Kesepakatan Kerja Sama Konservasi Energi", nomor: 302123, tipe: "PKS", user: "CSR", status: "Diproses" },
        { judul: "Kerja Sama Pengembangan Aplikasi Mobile", nomor: 302523, tipe: "MoU", user: "IT", status: "Diproses" },
        { judul: "NDA Proyek Penelitian AI", nomor: 302623, tipe: "NDA", user: "R&D", status: "Selesai" },
        { judul: "Perjanjian Kerja Sama Supply Chain", nomor: 302723, tipe: "PKS", user: "Operations", status: "Masuk" },
        { judul: "MoU Pelatihan Keterampilan Digital", nomor: 302823, tipe: "MoU", user: "HR", status: "Selesai" },
        { judul: "Kesepakatan Kerja Sama Logistik", nomor: 302923, tipe: "PKS", user: "Logistics", status: "Ditolak" },
