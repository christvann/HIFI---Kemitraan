      ...
      <div class="relative h-auto w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
        <div class="flex">
          ...
          <div class="relative mt-4 mb-4 items-start w-[209px] h-[72px] border-[1px] border-[#E5E7E9] rounded-md">
            ...
            <div v-if="showProgressMoUPopupStaff" class="fixed inset-0 flex items-center justify-center bg-[#1F2937] bg-opacity-50">
              <div class="bg-[#FFFFFF] re rounded-lg shadow-lg w-[684.92px] h-[538.92px] border-collapse">
                ...
                <div class="flex">
                  ...
                  <svg width="28" height="33" class="mt-[180px] ml-[195px]" viewBox="0 0 28 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div :class="[!fileUploaded2 ? 'bg-[#FFFFFF]' : boxClass3]" class="absolute flex flex-col w-[289px] h-[130px] rounded-lg mt-[240px] ml-[370px] border-[1px] border-[#DEDEDE]">
                    <div :class="!fileUploaded2 ? 'bg-[#E0E0E0]' : headerClass3" class="w-full h-[40px] p-4 flex justify-between items-center rounded-t-lg">
                      <div :class="!fileUploaded2 ? 'text-[#333333]' : 'text-[#FFFFFF]'" class="font-sans text-[14px] font-semibold">{{ fileUploaded3 ? "MoU/NDA" : "MoU/NDA" }}</div>
                    </div>
...
export default {
  data() {
    return {
      ...
      showDropdown: false,
      showProgressMoUPopupStaff: false,
