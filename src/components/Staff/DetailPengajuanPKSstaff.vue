    ...
    <div class="px-4 py-3">
      <div class="relative h-auto w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
                  ...
                  <div class="relative w-full">
                    ...
                    <button class="ml-4 block text-left p-2 bg-[#FFFFFF] w-full">
                      <div class="flex justify-between items-center">
                        <div class="overflow-hidden">
                          <span class="block text-sm font-semibold text-[#333333] font-sans text-[14px] truncate">
                            {{ fileDetails.Negosiasi.fileName || "negosiasi.pdf" }}
                          </span>
                        </div>
                      </div>
                    </button>
                  ...
                  <div class="relative w-full">
                    ...
                    <button class="ml-4 block text-left p-2 bg-[#FFFFFF] w-full">
                      <div class="flex justify-between items-center">
                        <div class="overflow-hidden">
                          <span class="block text-sm font-semibold text-[#333333] font-sans text-[14px] truncate">
                            {{ fileDetails.BAKPemilihanMitra?.fileName || "bak_pemilihan_mitra.pdf" }}
                          </span>
                        </div>
                      </div>
                    </button>
                  ...
                  <div class="relative w-full">
                    ...
                    <button class="ml-4 block text-left p-2 bg-[#FFFFFF] w-full">
                      <div class="flex justify-between items-center">
                        <div class="overflow-hidden">
                          <span class="block text-sm font-semibold text-[#333333] font-sans text-[14px] truncate">
                            {{ fileDetails.SuratPesanan?.fileName || "surat_pesanan.pdf" }}
                          </span>
                        </div>
                      </div>
                    </button>
                  ...
                  <div class="relative w-full">
                    ...
                    <button class="ml-4 block text-left p-2 bg-[#FFFFFF] w-full">
                      <div class="flex justify-between items-center">
                        <div class="overflow-hidden">
                          <span class="block text-sm font-semibold text-[#333333] font-sans text-[14px] truncate">
                            {{ fileDetails.PKS.fileName || "pks.pdf" }}
                          </span>
                        </div>
                      </div>
                    </button>
        ...
        <div class="flex flex-row w-[1046px] h-auto ml-4 py-9">
          <button
            @click="showPenyelesaianPKSPopup = true"
