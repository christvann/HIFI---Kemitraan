<template>
  ...
  <div class="px-4 py-3">
    <div class="h-[712px] w-[1086px] rounded-lg bg-[#FFFFFF] border-collapse mx-auto">
      <div class="flex">
                  ...
                  <td class="p-2 border border-[#E5E7E9]">
                    <span
                      :class="[
                        ...
                        item.status === 'Masuk' ? 'bg-[#E2FCF3] text-[#0EA976] border-[1px] border-[#8ADFC3]' : '',
                        item.status === 'Masuk' ? 'bg-[#E2FCF3] text-[#0EA976] border-[1px] border-[#8ADFC3]' : '',
                        item.status === 'Masuk' ? 'bg-[#E2FCF3] text-[#0EA976] border-[1px] border-[#8ADFC3]' : '',
                        item.status === 'Revisi Minor' ? 'bg-[#FFF3E6] text-[#FF8000] border-[#FFD6AD]' : '',
                        item.status === 'Revisi Mayor' ? 'bg-[#FFF8E1] text-[#E1BC37] border-[#F1D230]' : '',
                        item.status === 'Reject ke User' ? 'bg-[#FFE5E6] text-[#FF5656] border-[#FD8A8A]' : '',
                      ]"
                    >
                      {{ item.status }}
                    </span>
...
export default {
  data() {
    return {
      ...
      filterOptions: [
        ...
        { name: "Status", subOptions: ["Masuk", "Revisi Minor", "Revisi Mayor", "Reject ke User"] },
      ],
      ...
      tableData: [
        { judul: "Lorem ipsum dolor sit amet", nomor: 90225, tipe: "MoU", user: "Sales", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90226, tipe: "PKS", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90227, tipe: "MoU", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90228, tipe: "PKS", user: "Sales", status: "Revisi Minor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90229, tipe: "MoU", user: "Produk", status: "Revisi Mayor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90230, tipe: "MoU", user: "Sales", status: "Reject ke User" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90231, tipe: "MoU", user: "Sales", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90232, tipe: "PKS", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90233, tipe: "MoU", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90234, tipe: "PKS", user: "Sales", status: "Revisi Minor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90235, tipe: "MoU", user: "Produk", status: "Revisi Mayor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90236, tipe: "MoU", user: "Sales", status: "Reject ke User" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90237, tipe: "MoU", user: "Sales", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90238, tipe: "PKS", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90239, tipe: "MoU", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90240, tipe: "PKS", user: "Sales", status: "Revisi Minor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90241, tipe: "MoU", user: "Produk", status: "Revisi Mayor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90242, tipe: "MoU", user: "Sales", status: "Reject ke User" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90243, tipe: "MoU", user: "Sales", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90244, tipe: "PKS", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90245, tipe: "MoU", user: "Produk", status: "Masuk" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90246, tipe: "PKS", user: "Sales", status: "Revisi Minor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90247, tipe: "MoU", user: "Produk", status: "Revisi Mayor" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90248, tipe: "MoU", user: "Sales", status: "Reject ke User" },
        { judul: "Lorem ipsum dolor sit amet", nomor: 90249, tipe: "MoU", user: "Sales", status: "Masuk" },
      ],
      sortOrder: "asc",
    };
  },
    ...
    filteredAndPaginatedData() {
      ...
      if (this.selectedSubOptions.length) {
        filteredData = filteredData.filter((item) => {
          ...
          const isStatusMatched = this.selectedSubOptions.includes(item.status);
          return isTipeMatched || isStatusMatched;
        });
      }
  ...
  methods: {
    ...
    navigateToDetail() {
      this.$router.push("/masukstaff/detailpengajuanstaff");
    },
    toggleDropdown() {
